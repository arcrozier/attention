...
import com.aracroproducts.common.PriorityQueueSet
import com.aracroproducts.common.getSendIntent
...
class MainViewModel(
    ...
    fun sendAlert(
        ...
        viewModelScope.launch {
            ...
            if (token == null) {
                launchLogin(getSendIntent(context, message, MainActivity::class.java))
                return@launch
            }
